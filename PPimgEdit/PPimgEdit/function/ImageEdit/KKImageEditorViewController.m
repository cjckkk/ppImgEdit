...
//    }
    ...
    self.imageView.frame =CGRectMake(0,44,[UIScreen mainScreen].bounds.size.width,[UIScreen mainScreen].bounds.size.height-100);
    
    NSLog(@"image view frame is %@",NSStringFromCGRect(self.imageView.frame));
