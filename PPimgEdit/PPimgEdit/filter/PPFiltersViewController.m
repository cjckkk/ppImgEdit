...
//    [self.view addSubview:self.styleBar];
    ...
    self.filterStyleBar = [[FWEffectBar alloc] initWithFrame:CGRectMake(0, HEIGHT - 50 - kHeight, WIDTH, kHeight)];
